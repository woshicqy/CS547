...
parser.add_argument("--fine_tune", default=True, type=ast.literal_eval,
                    dest =  "fine_tune",
...
def main():
    ...
    for curt_epoch in tqdm(range(start_epoch, args.epochs)):
        ...
        test_accurracy = test(resnet,criterion,
                        test_data_loader,
                        device,debug=args.debug)
        test_acc.append(test_accurracy)
        train_acc = np.array(train_acc)
        test_acc = np.array(test_acc)
        np.save('pretrained_train.npy',train_acc)
        np.save('pretrained_test.npy',test_acc)
    ################################
